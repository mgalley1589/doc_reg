...
<?php 	 
  ...
  elseif ($pageurl == '/docs')
  	{$current = 'three';}
  elseif ($pageurl == '/number_templates_list')
  	{$current = 'four';}		
    ...
    <div id="container">
      ...
      <div id="main-container">
        ...
        <div class="title-wrapper" style="width:1150px;">
          <h2 style="padding:0 0 0 10px; width:100%;"><?php print $title ?>   <?php if ($user->uid == 1) { ?>
 <a href="/number-templates" class="btn primary" style="float:right; margin-right:100px;">+ Create Template</a> 
 <?php } else {} ;?></h2>       
        </div>
      ...
      <table class='views-table cols-7' style="margin-top:40px;">
<thead>
<tr>
...
<!--<a href="/number_templates_view/?tid=<?php echo $row['ntid'];?>">--><?php echo $row['title'];?><!--</a>-->
</td>
<td class='views-field'>
 <?php echo $row['client'];?>
</td>
<!--<td class='views-field'>
  <?php //echo "<a href='/edit-number-template/?tid=$row[ntid]'>View/Edit</a>";?>
</td>-->
