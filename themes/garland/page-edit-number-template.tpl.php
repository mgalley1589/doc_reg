...
<?php
$tid = $_GET['tid'];
$title = db_result(db_query("SELECT title FROM number_templates WHERE ntid=$tid"));
$seperator = db_result(db_query("SELECT seperator FROM number_templates WHERE ntid=$tid"));
$client = db_result(db_query("SELECT client FROM number_templates WHERE ntid=$tid"));
?>
<div id="template_Details" style="margin-bottom:4px;">
   <strong>Title:</strong>  &nbsp;  <input type="text" type="text" name="template_title" id="template_title" class="validate[required]" style="width:200px;" value="<?php echo $title;?>"/> &nbsp;  &nbsp; 
   <strong>Client:</strong> &nbsp;  <input type="text" name="template_client" id="template_client" style="width:200px;" value="<?php echo $client;?>"/> &nbsp;   &nbsp;
   <strong>Seperator:</strong> &nbsp; <input type="text" name="template_seperator" id="template_seperator" style="width:200px" value="<?php echo $seperator;?>"/>&nbsp;   &nbsp; <br/><br/>
</div>
 <br/><br/>
...
<br/><br/>
    ...
    <div id="container1" style="margin-bottom:4px;" class="clonedInput">
      <?php 
      $sql = "SELECT * FROM number_templates_ranges WHERE ntid=%d";
      $result = db_query($sql, $tid);
      while ($row = db_fetch_array($result)) {
        ?>
      
        <strong>Range Start:</strong>  &nbsp;  <input type="text" name="range_start" id="range_start" class="template_input" style="width:200px;" value="<?php echo $row[rangeStart];?>"/> &nbsp;  &nbsp; 
        <strong>Range End:</strong> &nbsp;  <input type="text" name="range_end" id="range_end" class="template_input" style="width:200px;"  value="<?php echo $row[last];?>"/> &nbsp;   &nbsp; 
        <strong>Title: </strong>  &nbsp;  <input type="text" name="range_title" id="range_title" class="template_input" style="width:200px;"  value="<?php echo $row[title];?>"/><br/><br/>
